...
SET(V8_LIBRARY_SEARCH_PATHS
    ...
    $ENV{V8_DIR}
    $ENV{V8_DIR}/lib
    ~/Downloads/AUR/v8/src/v8/out.gn/x64.release/obj
    ~/Library/Frameworks
    /Library/Frameworks
    /usr/local/lib
    /usr/lib
...
FIND_PATH(V8_INCLUDE_DIR v8.h
    ...
    $ENV{V8_DIR}/include
    $ENV{V8_DIR}
    ~/Downloads/AUR/v8/src/v8/include
    ~/Library/Frameworks
    /Library/Frameworks
    /usr/local/include
    /usr/include
...
ELSE()
    ...
    FIND_LIBRARY(V8_EXTERNAL_SNAPSHOT_LIBRARY
        NAMES v8_external_snapshot libv8_external_snapshot
        PATHS ${V8_LIBRARY_SEARCH_PATHS}
    )

    FIND_LIBRARY(V8_NO_SNAPSHOT_LIBRARY
